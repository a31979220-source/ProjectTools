  ...
  if (viewMode === 'details') {
    return (
      ...
      >
        ...
        {task.associatedPath && (
          <div className="px-2 py-1 bg-brand-500/10 text-brand-600 dark:text-brand-400 rounded-lg text-[11px] font-mono flex items-center justify-between gap-1 border border-brand-500/20">
